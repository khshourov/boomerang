...
## Verification Plan
- **Automated Tests:** Run `./gradlew :boomerang-cli:test`.
- **Manual Verification:** Build the CLI and run commands against a local `BoomerangServer`.
- **Mutation Testing:** Run `./gradlew :boomerang-cli:pitest` to ensure no regression in test quality.
